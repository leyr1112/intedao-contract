...
contract sInteToken is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10000000 * 10**18;
    ...
    constructor() ERC20("Staked InteDao", "sINTE", 9) ERC20Permit() {
    ...
    /**
        @notice increases sINTE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sINTE
