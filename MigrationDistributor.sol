...
contract MigrateDistributor is Policy {
    ...
    address public immutable sInteOld;
    
    address public newStaking;
    address public sInteNew;
    ...
    */
    ...
    constructor( address _treasury, address _inte, uint _epochLength, uint _nextEpochBlock, address _oldStaking, address _sInteOld, address _newStaking, address _sInteNew ) {
        ...
        require( _sInteOld != address(0) );
        sInteOld = _sInteOld;
        require( _newStaking != address(0) );
        newStaking = _newStaking;
        require( _sInteNew != address(0) );
        sInteNew = _sInteNew;
    ...
    function distribute() external returns ( bool ) {
        if ( nextEpochBlock <= block.number ) {
            ...
            uint oldReward= split(reward,ISINTE(sInteOld).circulatingSupply(),ISINTE(sInteNew).circulatingSupply());
    ...
    function setNewStaking(address _newStaking, address _sInteNew) external onlyPolicy() {
        require( _newStaking != address(0) );
        newStaking = _newStaking;
        require( _sInteNew != address(0) );
        sInteNew = _sInteNew;
